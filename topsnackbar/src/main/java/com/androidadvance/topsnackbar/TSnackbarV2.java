...
public final class TSnackbarV2 {
    ...
    public static abstract class Callback {
        ...
        public void onDismissed(TSnackbarV2 snackbar, @DismissEvent int event) {

        }


        public void onShown(TSnackbarV2 snackbar) {
    ...
    static {
        sHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
            ...
            public boolean handleMessage(Message message) {
                switch (message.what) {
                    case MSG_SHOW:
                        ((TSnackbarV2) message.obj).showView();
                        return true;
                    case MSG_DISMISS:
                        ((TSnackbarV2) message.obj).hideView(message.arg1);
                        return true;
                }
                return false;
            }
    ...
    private TSnackbarV2(ViewGroup parent) {
        mParent = parent;
    ...
    @NonNull
    public static TSnackbarV2 make(@NonNull View view, @NonNull CharSequence text,
                                   @Duration int duration) {
        TSnackbarV2 snackbar = new TSnackbarV2(findSuitableParent(view));
    ...
    @NonNull
    public static TSnackbarV2 make(@NonNull View view, @StringRes int resId, @Duration int duration) {
    ...
    @Deprecated
    public TSnackbarV2 addIcon(int resource_id, int size) {
     ...
     * @param aniresId
     */
    public void showLoading(@AnimRes int aniresId) {
        final ImageView refresh = mView.getRefreshView();
        refresh.setImageResource(R.mipmap.ic_rotate);
        final Animation animation = AnimationUtils.loadAnimation(mContext, aniresId);
    ...
    public void showLoadFailed() {
        final ImageView refresh = mView.getRefreshView();
        refresh.setImageResource(R.mipmap.ic_retry);
     ...
     * @param aniresId
     */
    public void showLoadSuccess(@AnimRes int aniresId) {
        final ImageView refresh = mView.getRefreshView();
        final Animation animation = AnimationUtils.loadAnimation(mContext, aniresId);
        animation.setInterpolator(new LinearInterpolator());
        refresh.startAnimation(animation);
    ...
    public TSnackbarV2 setIconPadding(int padding) {
        final TextView tv = mView.getMessageView();
    ...
    public TSnackbarV2 setIconLeft(@DrawableRes int drawableRes, float sizeDp) {
        final TextView tv = mView.getMessageView();
    ...
    public TSnackbarV2 setIconRight(@DrawableRes int drawableRes, float sizeDp) {
        final TextView tv = mView.getMessageView();
        Drawable drawable = ContextCompat.getDrawable(mContext, drawableRes);
        if (drawable != null) {
            drawable = fitDrawable(drawable, (int) convertDpToPixel(sizeDp, mContext));
     ...
     */
    public TSnackbarV2 setMaxWidth(int maxWidth) {
    ...
    @NonNull
    public TSnackbarV2 setAction(@StringRes int resId, View.OnClickListener listener) {
        return setAction(mContext.getText(resId), listener);
    }


    @NonNull
    public TSnackbarV2 setAction(CharSequence text, final View.OnClickListener listener) {
    ...
    @NonNull
    public TSnackbarV2 setActionTextColor(ColorStateList colors) {
        final TextView tv = mView.getActionView();
    ...
    @NonNull
    public TSnackbarV2 setActionTextColor(@ColorInt int color) {
        final TextView tv = mView.getActionView();
    ...
    @NonNull
    public TSnackbarV2 setText(@NonNull CharSequence message) {
        final TextView tv = mView.getMessageView();
        tv.setText(message);
        return this;
    }
    ...
    @NonNull
    public TSnackbarV2 setText(@StringRes int resId) {
        return setText(mContext.getText(resId));
    }


    @NonNull
    public TSnackbarV2 setDuration(@Duration int duration) {
        mDuration = duration;
        return this;
    }
    ...
    @NonNull
    public TSnackbarV2 setCallback(Callback callback) {
        mCallback = callback;
        return this;
    }
    ...
    private final SnackbarManager.Callback mManagerCallback = new SnackbarManager.Callback() {
        @Override
        public void show() {
            sHandler.sendMessage(sHandler.obtainMessage(MSG_SHOW, TSnackbarV2.this));
        }

        @Override
        public void dismiss(int event) {
            sHandler.sendMessage(sHandler.obtainMessage(MSG_DISMISS, event, 0, TSnackbarV2.this));
        }
    };
            ...
            ViewCompat.animate(mView)
                    ...
                    .setListener(new ViewPropertyAnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(View view) {
                            if (mCallback != null) {
                                mCallback.onShown(TSnackbarV2.this);
                            }
                            SnackbarManager.getInstance()
